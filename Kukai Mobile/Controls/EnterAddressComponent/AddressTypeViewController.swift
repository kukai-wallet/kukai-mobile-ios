...
class AddressTypeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
	...
	static func imageFor(addressType: AddressType) -> UIImage {
		var tempMetadata = WalletMetadata(address: "", hdWalletGroupName: nil, type: .regular, children: [], isChild: false, isWatchOnly: false, bas58EncodedPublicKey: "")
		
		switch addressType {
			case .tezosAddress:
				tempMetadata = WalletMetadata(address: "", hdWalletGroupName: nil, type: .regular, children: [], isChild: false, isWatchOnly: false, bas58EncodedPublicKey: "")
			...
			case .tezosDomain:
				...
				tempMetadata = WalletMetadata(address: "", hdWalletGroupName: nil, walletNickname: nil, socialUsername: nil, mainnetDomains: [fakeRecord], ghostnetDomains: [fakeRecord], type: .regular, children: [], isChild: false, isWatchOnly: false, bas58EncodedPublicKey: "")
				
			case .gmail:
				tempMetadata = WalletMetadata(address: "", hdWalletGroupName: nil, walletNickname: nil, socialUsername: nil, socialType: .google, type: .social, children: [], isChild: false, isWatchOnly: false, bas58EncodedPublicKey: "")
				
			case .reddit:
				tempMetadata = WalletMetadata(address: "", hdWalletGroupName: nil, walletNickname: nil, socialUsername: nil, socialType: .reddit, type: .social, children: [], isChild: false, isWatchOnly: false, bas58EncodedPublicKey: "")
				
			case .twitter:
				tempMetadata = WalletMetadata(address: "", hdWalletGroupName: nil, walletNickname: nil, socialUsername: nil, socialType: .twitter, type: .social, children: [], isChild: false, isWatchOnly: false, bas58EncodedPublicKey: "")
		}
