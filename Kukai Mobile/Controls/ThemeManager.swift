	...
	public func setup() {
		ThemeManager.shared.setup(
			lightColors: [
				...
				"gradPanelRows_Alert-1": UIColor("#FF759E", alpha: 0.2),
				"gradPanelRows_Alert-2": UIColor("#FF759E", alpha: 0.15),
			...
			darkColors: [
				...
				"gradPanelRows_Black-1": UIColor("#C0C0CE", alpha: 0.13),
				"gradPanelRows_Black-2": UIColor("#D2D2DB", alpha: 0.1),
				"gradPanelRows_Alert-1": UIColor("#D34C74", alpha: 0.2),
				"gradPanelRows_Alert-2": UIColor("#D34C74", alpha: 0.15),
