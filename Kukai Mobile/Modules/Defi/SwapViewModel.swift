...
class SwapViewModel: ViewModel {
	...
	var tokenFromIconImage: UIImage? = UIImage(named: "tezos-xtz-logo")
	...
	func updateTokenInfo() {
		...
		if xtzToToken {
			tokenFromTitle = "XTZ"
			tokenFromIconImage = UIImage(named: "tezos-xtz-logo")
			...
			tokenToTitle = "XTZ"
			tokenToIconImage = UIImage(named: "tezos-xtz-logo")
			tokenToIconURL = nil
